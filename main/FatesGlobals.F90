...
contains
  ...
  subroutine err_msg_supp1()
    ...
    write(fates_log(),*)'________________________________________________________________'
    write(fates_log(),*)''
    write(fates_log(),*)'             ___ _  _ ____    ____ ____ ____ ____ _  _ '
    write(fates_log(),*)'              |  |__| |___    |    |__/ |__| [__  |__|  ' 
    write(fates_log(),*)'              |  |  | |___    |___ |  \ |  | ___] |  |   ' 
    write(fates_log(),*)'  '
    write(fates_log(),*)'                    ___  ____ ____ ____   ' 
    write(fates_log(),*)'                    |__] |__| [__  [__    '
    write(fates_log(),*)'                    |__] |  | ___] ___]   '
    write(fates_log(),*)'  '
    write(fates_log(),*)''
    write(fates_log(),*)''   
    write(fates_log(),*)'      A magic bass has crashed into your simulation. '   
    write(fates_log(),*)''
    write(fates_log(),*)'      Do you choose to?'   
    write(fates_log(),*)''
    write(fates_log(),*)'      a) Defend yourself! Hurl a magic cod at the evil warlock?'
    write(fates_log(),*)'         Turn to page 146'
    write(fates_log(),*)''
    write(fates_log(),*)'      b) Run! Your spy a patch of coastal grasses that may aid your escape.'
    write(fates_log(),*)'         Turn to page 81'
    write(fates_log(),*)''
    write(fates_log(),*)'      c) Summon the ED2 fail whale?'
    write(fates_log(),*)'         Turn to page 214'
    write(fates_log(),*)''                 
    write(fates_log(),*)''
    write(fates_log(),*)'                                       /..:-                                     '
    write(fates_log(),*)'                                 -.-o+++o+++           ``.--::////////::--.--.   '

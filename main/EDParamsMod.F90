module EDParamsMod
 ...
 contains
  ...
  subroutine FatesParamsInit()
    ...
    hydr_psi0                             = fates_unset_r8
    hydr_psicap                           = fates_unset_r8
    bgc_soil_salinity                     = fates_unset_r8
    logging_dbhmin                        = fates_unset_r8
    logging_dbhmax                        = fates_unset_r8
    logging_collateral_frac               = fates_unset_r8
    logging_direct_frac                   = fates_unset_r8
    logging_mechanical_frac               = fates_unset_r8
    logging_event_code                    = fates_unset_r8
    logging_dbhmax_infra                  = fates_unset_r8
    logging_export_frac                   = fates_unset_r8
    eca_plant_escalar                     = fates_unset_r8
    q10_mr                                = fates_unset_r8
    q10_froz                              = fates_unset_r8
    dev_arbitrary                         = fates_unset_r8
    damage_event_code                     = -9
    damage_canopy_layer_code              = -9
    landuse_grazing_carbon_use_eff        = fates_unset_r8
    landuse_grazing_nitrogen_use_eff      = fates_unset_r8
    landuse_grazing_phosphorus_use_eff    = fates_unset_r8
    landuse_grazing_maxheight             = fates_unset_r8
    landuse_grazing_rate(:)               = fates_unset_r8

module EDMainMod
  ...
  use EDPhysiologyMod          , only : UpdateRecruitVmaxL2FR
  use EDPhysiologyMod          , only : UpdateRecruitStoich
  use EDPhysiologyMod          , only : SetRecruitVmaxL2FR
...
contains
  ...
  subroutine ed_integrate_state_variables(currentSite, bc_in, bc_out )
   ...
   call UpdateRecruitVmaxL2FR(currentSite)
  ...
  subroutine ed_update_site( currentSite, bc_in, bc_out, is_restarting )
    ...
    call SetRecruitVmaxL2FR(currentSite)

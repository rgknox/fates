module FatesHistoryInterfaceMod
  ...
  type, public :: fates_history_interface_type
     ...
     integer :: patch_index_, column_index_, levgrnd_index_, levscpf_index_
     integer :: levscls_index_, levpft_index_, levage_index_
     integer :: levfuel_index_, levcwdsc_index_, levscag_index_
     integer :: levcan_index_, levcnlf_index_, levcnlfpft_index_
     integer :: levscagpft_index_, levagepft_index_
     integer :: levheight_index_
   contains
     ...
     procedure :: define_history_vars
     procedure :: set_history_var
     procedure :: init_dim_kinds_maps
     procedure :: set_dim_indices
     procedure :: flush_hvars

     procedure :: set_patch_index
     procedure :: set_column_index
     procedure :: set_levgrnd_index
     procedure :: set_levscpf_index
     procedure :: set_levscls_index
     procedure :: set_levpft_index
     procedure :: set_levage_index
     procedure :: set_levfuel_index
     procedure :: set_levcwdsc_index
     procedure :: set_levcan_index
     procedure :: set_levcnlf_index
     procedure :: set_levcnlfpft_index
     procedure :: set_levscag_index
     procedure :: set_levscagpft_index
     procedure :: set_levagepft_index
     procedure :: set_levheight_index

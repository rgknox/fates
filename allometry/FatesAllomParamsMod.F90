module PRTInitParamsFatesMod
  ...
  public :: AllomRegisterParams
  public :: AllomReceiveParams
  public :: AllomCheckParams
  public :: AllomDerivedParams
  !-----------------------------------------------------------------------
...
contains
  ...
  subroutine AllomRegisterParams(allom_params)

    class(fates_parameters_type), intent(inout) :: fates_params
    
    call AllomRegisterPFT(fates_params)

    call PRTRegisterOrgan(fates_params)
    
  end subroutine AllomRegisterParams

  !-----------------------------------------------------------------------
  subroutine AllomReceiveParams(fates_params)
  ...
  end subroutine AllomReceiveParams
  ...
  subroutine AllomRegisterPFT(fates_params)
  ...
  end subroutine AllomRegisterPFT
  
  !-----------------------------------------------------------------------
  
  subroutine AllomReceivePFT(fates_params)
  ...
  end subroutine AllomReceivePFT
  ...
  subroutine AllomDerivedParams()
    ...
    return
  end subroutine AllomDerivedParams
    
  ! =====================================================================================
  
  subroutine AllomCheckParams(is_master)
...
!        end if
     ...
     return
   end subroutine AllomCheckParams

...
${FC} ${F_OPTS} -o photo_infer PhotoNNInfer.F90  -L${FTorch_DIR} -lftorch -ltorch -ltorch_cpu -I${FTorch_DIR}/modules/ -L${Torch_DIR}/lib/ -L./bld -I bld/ -J./bld/ bld/photo_infer.a -Wl,-rpath,bld/

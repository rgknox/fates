program FatesTestTwostream
  ...
  ! CONSTANTS:
  character(len=*), parameter :: out_file = 'twostream_out.nc'    ! output file
  ...
  interface
     ...
     subroutine WriteTwostreamData(out_file, )
    ...
    end subroutine WriteTwostreamData
